    ...
    <header>
        <div class="image-text">
            ...
            <div class="text header-text">
                ...
                <span class="name">{{ $user->student->full_name ?? '' }}</span>
            </div>
        </div>
...
{{--            </li>--}}
            <ul class="menu-links">
                <li class="nav-link {{ request()->routeIs('student.index') ? 'active' : '' }}">
                    <a href="{{ route('student.index') }}">
                        <i class='bx bx-home-alt icon'></i>
                        <span class="text nav-text">Trang chủ</span>
                    </a>
                </li>
                <li class="nav-link {{ request()->routeIs('student.get-list-class-session', 'student.get-class-session') ? 'active' : '' }}">
                    <a href="{{ route('student.get-list-class-session') }}">
