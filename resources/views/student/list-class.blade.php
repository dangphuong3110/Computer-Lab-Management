                ...
                <table class="table table-bordered border-black">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-center" width="25%">Giảng viên</th>
                            <th scope="col" class="text-center" width="25%">Bắt đầu - kết thúc</th>
                            <th scope="col" class="text-center action-column" width="10%">Hành động</th>
                        </tr>
                    </thead>
                    <tbody>
                        @if(count($classes) > 0)
