    ...
    <header>
        <div class="image-text">
            ...
            <div class="text header-text">
                ...
                <span class="name">{{ $user->lecturer->full_name ?? '' }}</span>
            </div>
        </div>
...
{{--            </li>--}}
            <ul class="menu-links">
                ...
                <li class="nav-link {{ request()->routeIs('lecturer.get-list-class-session', 'lecturer.get-class-session') ? 'active' : '' }}">
                    <a href="{{ route('lecturer.get-list-class-session') }}">
